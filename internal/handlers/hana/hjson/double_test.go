...
func TestDouble(t *testing.T) {
	t.Parallel()
	testJSON(t, doubleTestCases, func() hjsontype { return new(doubleType) })
}

func FuzzDouble(f *testing.F) {
	fuzzJSON(f, doubleTestCases, func() hjsontype { return new(doubleType) })
}

func BenchmarkDouble(b *testing.B) {
	benchmark(b, doubleTestCases, func() hjsontype { return new(doubleType) })
}
