...
func TestBinary(t *testing.T) {
	t.Parallel()
	testJSON(t, binaryTestCases, func() hjsontype { return new(binaryType) })
}

func FuzzBinary(f *testing.F) {
	fuzzJSON(f, binaryTestCases, func() hjsontype { return new(binaryType) })
}

func BenchmarkBinary(b *testing.B) {
	benchmark(b, binaryTestCases, func() hjsontype { return new(binaryType) })
}
