...
func TestRegex(t *testing.T) {
	t.Parallel()
	testJSON(t, regexTestCases, func() hjsontype { return new(regexType) })
}

func FuzzRegex(f *testing.F) {
	fuzzJSON(f, regexTestCases, func() hjsontype { return new(regexType) })
}

func BenchmarkRegex(b *testing.B) {
	benchmark(b, regexTestCases, func() hjsontype { return new(regexType) })
}
