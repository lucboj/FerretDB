...
func TestDocument(t *testing.T) {
	t.Parallel()
	testJSON(t, documentTestCases, func() hjsontype { return new(documentType) })
}

func FuzzDocument(f *testing.F) {
	fuzzJSON(f, documentTestCases, func() hjsontype { return new(documentType) })
}

func BenchmarkDocument(b *testing.B) {
	benchmark(b, documentTestCases, func() hjsontype { return new(documentType) })
}
