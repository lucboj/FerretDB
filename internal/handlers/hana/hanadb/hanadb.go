...
var (
	// ErrCollectionNotExist indicates that there is no such collection.
	ErrCollectionNotExist = fmt.Errorf("collection does not exist")

	// ErrSchemaNotExist indicates that there is no such schema.
	ErrSchemaNotExist = fmt.Errorf("database/schema does not exist")

	// ErrAlreadyExist indicates that a schema or collection already exists.
	ErrAlreadyExist = fmt.Errorf("database/schema or collection already exists")
