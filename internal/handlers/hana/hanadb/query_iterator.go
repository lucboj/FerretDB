...
var queryIteratorProfiles = pprof.NewProfile("github.com/FerretDB/FerretDB/internal/handlers/pg/hanadb.queryIterator")

// queryIterator implements iterator.Interface to fetch documents from the database.
type queryIterator struct {
	ctx       context.Context
	unmarshal func(b []byte) (*types.Document, error) // defaults to hjson.Unmarshal.
...
// newIterator returns a new queryIterator for the given *sql.Rows.
//
